                  ...
                  <section className="bg-white/60 backdrop-blur-sm rounded-xl p-8 shadow-lg border border-teal-200">
                    ...
                    <div className="prose prose-teal max-w-none text-left">
                      ...
                      <div className="space-y-4 mt-6">
                        <div className="space-y-2">
                          <h3 className="font-semibold text-teal-700">Orca Protocol Fees:</h3>
                        ...
                        <div className="space-y-2">
                          <h3 className="font-semibold text-teal-700">App Functionality:</h3>
                          <p className="text-gray-700">
                        ...
                        <div className="space-y-2">
                          <h3 className="font-semibold text-teal-700">High Yield Potential:</h3>
                          <p className="text-gray-700">
                        ...
                        <div className="space-y-2">
                          <h3 className="font-semibold text-teal-700">Fee Distribution:</h3>
